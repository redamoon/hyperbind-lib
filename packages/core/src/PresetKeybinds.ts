...
export const LEDGER_KEYBINDS: PresetKeybind[] = [
  ...
  },
  {
    ...
    category: "ledger",
    description:
      "参照画面が表示されます。カーソルがある項目に応じて、他の台帳を参照して入力することができます。",
    preventDefault: true,
  },
  {
...
export const INVOICE_KEYBINDS: PresetKeybind[] = [
  ...
  },
  {
    ...
    category: "invoice",
    description:
      "得意先台帳（仕入先台帳）で設定した［出力方法］によって、帳票を取引先にPDF送信します。",
    preventDefault: true,
  },
  {
    ...
    category: "invoice",
    description:
      "参照画面が表示されます。伝票の日付または伝票番号で参照すると、登録済みの伝票を呼び出して修正や削除を行うことができます。",
    preventDefault: true,
  },
  {
...
export const BUSINESS_KEYBINDS: PresetKeybind[] = [
  ...
  },
  {
    ...
    category: "report",
    description:
      "得意先台帳（仕入先台帳）で設定した［出力方法］によって、請求書や支払書を取引先にPDF送信します。",
    preventDefault: true,
  },
  {
  ...
  },
  {
    ...
    category: "report",
    description:
      "参照画面が表示されます。カーソルがある項目に応じて、台帳を参照して入力することができます。",
    preventDefault: true,
  },
  {
